    ...
    <>
      ...
      <NoteSection title="四条运动规则，就这些">
        ...
        <p>
          ...
          不是参数，是「只肯走左下右下、
          不肯走正左正右」的直接后果。水面找平也不是解出来的，
          就是一格一格挤过去 —— 面板上那个「每帧最多铺开几格」
          调大调小，水的黏稠感当场就变。
        </p>
      </NoteSection>
      ...
      <NoteSection title="脏块：这一页真正的主角">
        ...
        <p>
          代价是一处很容易漏的细节：一格像素动了之后，除了自己所在的块，
          还得叫醒<span className="text-ink">挨着的那一块</span>
          —— 它的下一步可能跨过边界，而对面此刻也许正睡着。
          漏掉这句的症状很典型：沙子流到块边缘就卡住，直到别的东西碰它一下。
        </p>
      </NoteSection>
